...
public class Collector {
    ...
    public static void startCollecting(int numberOfReducers) throws IOException {
        allDataCollectedLatch = new CountDownLatch(numberOfReducers); // initialize the latch to let the method receive data from all reducers to stop other threads from executing.
